        ...
        <div class="row px-xl-5">
            <div class="col-lg-3 d-none d-lg-block">
                {{-- <a href="" class="text-decoration-none ">
                    ...
                    <span class="h3 text-uppercase text-primary px-2 ml-n1 mt-5">My Shop</span>
                </a> --}}
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <div class="dropdown mb-3 d-inline me-5">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item my-3" href="{{route("user#accountPage")}}"><i class="fa-solid fa-user me-1"></i>Account</a></li>
