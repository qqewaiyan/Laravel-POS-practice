                    ...
                    <table class="table table-data2 text-center">
                        ...
                        <tbody >
                            ...
                            <tr class="tr-shadow">
                                ...
                                <td class="col-2"><i class="fa-solid fa-eye mr-2"></i>{{$pizza->view_count}}</td>
                                <td class="col-2">
                                    <div class="table-data-feature justify-content-center">

                                        <a href="{{route("product#edit",$pizza->id)}}"><button class="item " data-toggle="tooltip" data-placement="top" title="View">
                                            <i class="fa-solid fa-eye"></i>
                                        </button></a>
                                        <a href="{{route("product#updatePage",$pizza->id)}}"><button class="item mx-2" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <i class="fa-solid fa-pen-to-square"></i>
                                        </button></a>
                                      <a href="{{route("product#delete",$pizza->id)}}">  <button class="item"  data-toggle="tooltip" data-placement="top"  title="Delete">
